...
root_dir = '/work/projects/project02629/datasets/dataset_dir_original/PhysioNet-MI/files'
...
db = lmdb.open('/work/projects/project02629/datasets/processed/PhysioNet-MI', map_size=4614542346)

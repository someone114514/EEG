...
# PARAMETERS
signals_path = r"/work/projects/project02629/datasets/dataset_dir_original/chb-mit-scalp-eeg-database-1.0.0"  # Path to the data main directory
clean_path = r"/work/projects/project02629/datasets/dataset_dir_original/processed1"  # Path where to store clean data
